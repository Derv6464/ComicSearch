# this gets the character data for each comic

import requests
from bs4 import BeautifulSoup
import re
import csv
f = open("AllLinks2.csv","r")
d = open("feat2.csv","w")
s = open("suppChar2.csv","w")
o = open("otherChar2.csv","w")
a = open("antagChar2.csv","w") #opening files

dataIn = f.read()
list1 = dataIn.split("\n")
for i in range(len(list1)):            #for ammount of links
